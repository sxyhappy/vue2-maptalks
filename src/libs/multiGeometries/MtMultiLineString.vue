...
export default {
  ...
  methods: {
    generateGeometry() {
      if (!Array.isArray(this.coordinates) || this.coordinates.length === 0) throw new Error('multi-line-string coordinates can not be empty');

      this.geometry = new MultiLineString(this.coordinates, mergeProps(this));
