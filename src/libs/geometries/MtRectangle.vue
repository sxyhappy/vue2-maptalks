...
export default {
  ...
  methods: {
    generateGeometry() {
      if (!this.coordinates) throw new Error('rectangle coordinates can not be empty');
      ...
      this.geometry = new Rectangle(this.coordinates, this.width, this.height, mergeProps(this));
