  ...
  <div class="map">
    <mt-map :zoom="12" :center="[121.48053653961283, 31.24244899384889]">
      ...
      <mt-vector-layer id="vector">
        <mt-rectangle :coordinates="[121.48053653961283, 31.24244899384889]" :width="1000" :height="1000" :visible="visible" cursor="pointer">
...
## Props
#### options 支持 mt-rectangle 除 coordinates 的全部属性
:::warning
...
| width | 宽度 | Number |  | required |
| height | 高度 | Number |  | required |
